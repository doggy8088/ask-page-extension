...
const modalCommandPrompt = document.getElementById('modalCommandPrompt');
    ...
    div.innerHTML = `
        <div class="command-header">
            ...
            <div class="command-actions">
                ...
                ${isEditable ? `<button class="btn-secondary btn-small" onclick="editCommand('${command.cmd}')">
                    <span class="icon">✏️</span>
                    編輯
                </button>` : ''}
                ${!isBuiltIn ? `<button class="btn-danger btn-small" onclick="deleteCommandByName('${command.cmd}')">
                    <span class="icon">🗑️</span>
                    刪除
                </button>` : ''}
            </div>
...
window.editCommand = function(cmdName) {
...
window.deleteCommandByName = function(cmdName) {
